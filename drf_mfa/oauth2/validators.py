...
from drf_mfa.oauth2.exceptions import (
    ChallengeRequiredMessage,
    InvalidLoginError,
)
from drf_mfa.services import MultiFactorChallenge, verify_mfa_code
...
class MFAOAuth2Validator(OAuth2Validator):
    ...
    def validate_user(
        ...
        :raises drf_mfa.oauth2.exceptions.InvalidLoginError: If invalid MFA
            code or backup code are submitted. Also if both types of code are
            submitted simultaneously.
        :raises drf_mfa.oauth2.exceptions.ChallengeRequiredMessage: If the user
