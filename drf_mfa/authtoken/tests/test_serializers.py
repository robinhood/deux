...
from drf_mfa.constants import DISABLED, SMS
from drf_mfa.authtoken.serializers import MFAAuthTokenSerializer
from drf_mfa.services import generate_mfa_code
from drf_mfa.tests.test_base import BaseUserTestCase
...
class MFAAuthTokenSerializerTest(BaseUserTestCase):
    ...
    @patch("drf_mfa.authtoken.serializers.MultiFactorChallenge")
